...
//////////////////////////////////////////////////////////////////////////////////////////////////////
// ENUMITEM FILE:
// The EnumItemFile is a list (one per line) of: ENUMITEM(EnumItem) or ENUMITEM_VALUE(EnumItem, Value)
//////////////////////////////////////////////////////////////////////////////////////////////////////
// ALTERNATIVE TO ENUMITEM FILE: IMPROVED_ENUM_LIST instead of IMPROVED_ENUM_FILE
// #define IMPROVED_ENUM_LIST  ENUMITEM(Item1) ENUMITEM(Item2) ... ENUMITEM(LastItem)
...
namespace IMPROVED_ENUM_NAME
{
	...
	STATIC_METHOD inline const EnumType PreviousEnumItem(const EnumType& t)
	{
		...
		#define  ENUMITEM(EnumItem) if (t == EnumItem) return tprev; else tprev = EnumItem;
		#define  ENUMITEM_VALUE(EnumItem, Value) ENUMITEM(EnumItem)
		#ifdef   IMPROVED_ENUM_INHERITED_FILE
		#include IMPROVED_ENUM_INHERITED_FILE
		#endif// IMPROVED_ENUM_INHERITED_FILE
	...
	//////////////////////////////////////////
	STATIC_METHOD inline const EnumType FirstEnumItem() { return NextEnumItem(NotValidEnumItem); }
	STATIC_METHOD inline const EnumType LastEnumItem() { return PreviousEnumItem(NotValidEnumItem); }
	...
	////////////////////////////////////////////////////////////////////
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType Inherited2Enum(const EnumType& t) { return t; }
		STATIC_METHOD inline const EnumType Inherited2Enum(const IMPROVED_ENUM_INHERITED_NAME::EnumType& t)
		{
			switch (t)
			{
			//////////////////////////////////////////
			...
			#define  ENUMITEM(EnumItem) case IMPROVED_ENUM_INHERITED_NAME::EnumItem : return EnumItem;
			#define  ENUMITEM_VALUE(EnumItem, Value) ENUMITEM(EnumItem)
			#ifdef   IMPROVED_ENUM_INHERITED_FILE
			#include IMPROVED_ENUM_INHERITED_FILE
			#endif// IMPROVED_ENUM_INHERITED_FILE
		...
		//! other items are converted from one namespace to the other:
		//////////////////////////////////////////
		STATIC_METHOD inline const IMPROVED_ENUM_INHERITED_NAME::EnumType Enum2Inherited(const IMPROVED_ENUM_INHERITED_NAME::EnumType& t) { return t; }
		STATIC_METHOD inline const IMPROVED_ENUM_INHERITED_NAME::EnumType Enum2Inherited(const EnumType& t)
		{
			switch (t)
			{
			//////////////////////////////////////////
			...
			// a CASE list which returns the converted value
			// from one namespace to the other:
			#define  ENUMITEM(EnumItem) case EnumItem : return IMPROVED_ENUM_INHERITED_NAME::EnumItem;
			#define  ENUMITEM_VALUE(EnumItem, Value) ENUMITEM(EnumItem)
			#ifdef   IMPROVED_ENUM_INHERITED_FILE
			#include IMPROVED_ENUM_INHERITED_FILE
			#endif// IMPROVED_ENUM_INHERITED_FILE
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType NextExtendedEnumItem(const EnumType& t)
		{
			switch (t)
			{
			case NotValidEnumItem : 
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType PreviousExtendedEnumItem(const EnumType& t)
		{
			EnumType tprev = NotValidEnumItem;
			//////////////////////////////////////////
			// With this mini-macro we make ENUMITEM file/s
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType FirstExtendedEnumItem() { return NextExtendedEnumItem(NotValidEnumItem); }
		STATIC_METHOD inline const EnumType LastExtendedEnumItem() { return PreviousExtendedEnumItem(NotValidEnumItem); }
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType NextInheritedEnumItem(const EnumType& t)
		{
			switch (t)
			{
			case NotValidEnumItem : 
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType PreviousInheritedEnumItem(const EnumType& t)
		{
			EnumType tprev = NotValidEnumItem;
			//////////////////////////////////////////
			// With this mini-macro we make ENUMITEM file/s
		...
		//////////////////////////////////////////
		STATIC_METHOD inline const EnumType FirstInheritedEnumItem() { return NextInheritedEnumItem(NotValidEnumItem); }
		STATIC_METHOD inline const EnumType LastInheritedEnumItem() { return PreviousInheritedEnumItem(NotValidEnumItem); }
